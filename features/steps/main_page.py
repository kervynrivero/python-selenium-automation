...
PRODUCT_LOCATOR=(By.CSS_SELECTOR, "#addToCartButtonOrTextIdFor79578014")
PRODUCT_LOCATOR2 = (By.CSS_SELECTOR, "#addToCartButtonOrTextIdFor79578014.styles__StyledBaseButtonInternal-sc-ysboml-0[aria-label*='Add to cart']")
